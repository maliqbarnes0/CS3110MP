...
(** [calc_collision_point b1 b2] is the point on the surface where bodies
    [b1] and [b2] touch during a collision. *)
val calc_collision_point : Body.b -> Body.b -> Vec3.v

(** [update_trails trails world all_collisions] is [(new_trails, collision_pairs)]
    where [new_trails] is the updated trail histories with new positions from
    [world] and [collision_pairs] contains the collision information. *)
val update_trails :
  Vec3.v list list ->
  Body.b list ->
  (Body.b * Body.b) list ->
