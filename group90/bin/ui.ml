...
let draw_ui is_colliding time_scale paused planet_params has_changes
  ...
  draw_line (sidebar_x + 10) 35
    (sidebar_x + sidebar_width - 10)
    35 (color 80 100 140 255);
  ...
  draw_text "[1-6] Switch scenario" (sidebar_x + 15) 507 10
    (color 180 180 200 255);
  draw_text "[R] Restart w/ sliders" (sidebar_x + 15) 520 10
    (color 180 180 200 255);

  (* Bottom controls *)
  draw_line (sidebar_x + 10) 535
    (sidebar_x + sidebar_width - 10)
    535 (color 50 60 80 255);
  draw_text
    (Printf.sprintf "Speed: %.1fx" time_scale)
    (sidebar_x + 15) 543 12 white;
  draw_text "[Z] Faster  [X] Slower" (sidebar_x + 15) 560 10
    (color 180 180 200 255);
  draw_text
    (if paused then "[P] Resume" else "[P] Pause")
    (sidebar_x + 15) 576 11 (color 180 180 200 255);
