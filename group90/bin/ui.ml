...
let draw_instructions time_scale paused current_scenario =
  ...
  draw_line (box_x + 5) (box_y + 40)
    (box_x + box_width - 5)
    (box_y + 40) (color 50 60 80 255);

  (* Scenario list *)
  draw_text "[1] Three-Body" (box_x + 10) (box_y + 48) 8 (color 180 180 200 255);
  draw_text "[2] Randomized" (box_x + 10) (box_y + 60) 8 (color 180 180 200 255);
  draw_text "[3] Binary Star" (box_x + 10) (box_y + 72) 8
    (color 180 180 200 255);
  draw_text "[4] Solar System" (box_x + 10) (box_y + 84) 8
    (color 180 180 200 255);
  draw_text "[5] Collision" (box_x + 10) (box_y + 96) 8 (color 180 180 200 255);
  draw_text "[R] Restart" (box_x + 10) (box_y + 108) 8 (color 180 180 200 255);

  draw_line (box_x + 5) (box_y + 132)
    (box_x + box_width - 5)
    (box_y + 132) (color 50 60 80 255);

  (* Controls *)
  draw_text
    (Printf.sprintf "Speed: %.1fx" time_scale)
    (box_x + 10) (box_y + 140) 10 white;
  draw_text "[Z/X] Speed" (box_x + 10) (box_y + 153) 8 (color 180 180 200 255);
  draw_text
...
let draw_sidebar selected_planet_idx planet_params world num_alive =
  ...
  draw_rectangle
    (sidebar_x + sidebar_width - 40)
    selector_y 25 25 (color 60 70 90 255);
